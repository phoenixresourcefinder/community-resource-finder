...
/*
   SPANISH CONTENT
   ---------------
   Resource names are proper organization/program names and remain unchanged.
   All user-facing descriptions, instructions, eligibility, document guidance,
   costs, hours, language labels, and UI text are translated when Spanish is active.
*/
const ES_PHRASES = [
  ["Free or low-cost", "Gratis o de bajo costo"], ["Check official website", "Consulta el sitio oficial"], ["Use the official", "Utiliza el sitio oficial"],
  ["Open the official", "Abre el sitio oficial"], ["Start with the official", "Comienza con el sitio oficial"], ["official website", "sitio oficial"],
  ["website", "sitio web"], ["current", "actual"], ["currently", "actualmente"], ["confirm", "confirma"], ["confirmation", "confirmación"],
  ["information", "información"], ["resources", "recursos"], ["resource", "recurso"], ["directory", "directorio"], ["searchable", "con capacidad de búsqueda"],
  ["search", "búsqueda"], ["assistance", "ayuda"], ["support", "apoyo"], ["services", "servicios"], ["service", "servicio"],
  ["programs", "programas"], ["program", "programa"], ["eligible", "elegibles"], ["eligibility", "requisitos de elegibilidad"], ["requirements", "requisitos"],
  ["required", "requerido"], ["application", "solicitud"], ["apply", "solicita"], ["appointment", "cita"], ["appointments", "citas"],
  ["households", "hogares"], ["household", "hogar"], ["families", "familias"], ["family", "familia"], ["residents", "residentes"], ["resident", "residente"],
  ["people", "personas"], ["older adults", "adultos mayores"], ["young people", "jóvenes"], ["children", "niños"], ["child", "niño"],
  ["adults", "adultos"], ["adult", "adulto"], ["community", "comunitario"], ["communities", "comunidades"], ["local", "local"], ["statewide", "estatal"],
  ["Arizona-wide", "de todo Arizona"], ["throughout Arizona", "en todo Arizona"], ["throughout the Phoenix area", "en toda el área de Phoenix"],
  ["Phoenix-area", "del área de Phoenix"], ["Phoenix metro area", "área metropolitana de Phoenix"], ["central Phoenix", "Phoenix central"],
  ["north Phoenix", "Phoenix norte"], ["south Phoenix", "Phoenix sur"], ["Mesa-area", "del área de Mesa"], ["Tempe residents", "residentes de Tempe"],
  ["food assistance", "ayuda alimentaria"], ["food pantry", "despensa de alimentos"], ["food pantries", "despensas de alimentos"], ["food bank", "banco de alimentos"],
  ["food banks", "bancos de alimentos"], ["food distributions", "distribuciones de alimentos"], ["food resources", "recursos alimentarios"], ["food delivery", "entrega de alimentos"],
  ["Emergency food", "Alimentos de emergencia"], ["emergency food", "alimentos de emergencia"], ["Emergency assistance", "Ayuda de emergencia"], ["emergency assistance", "ayuda de emergencia"],
  ["Meals", "Comidas"], ["meals", "comidas"], ["meal programs", "programas de comidas"], ["fresh produce", "productos frescos"], ["affordable produce", "productos frescos asequibles"],
  ["housing assistance", "ayuda para vivienda"], ["housing resources", "recursos de vivienda"], ["affordable housing", "vivienda asequible"], ["rental assistance", "ayuda para el alquiler"],
  ["rental housing", "vivienda de alquiler"], ["housing programs", "programas de vivienda"], ["shelter", "refugio"], ["homelessness", "falta de vivienda"],
  ["supportive housing", "vivienda con apoyo"], ["housing services", "servicios de vivienda"], ["rental rights", "derechos de alquiler"], ["eviction", "desalojo"],
  ["healthcare", "atención médica"], ["health care", "atención médica"], ["health services", "servicios de salud"], ["health centers", "centros de salud"],
  ["medical", "médica"], ["dental", "dental"], ["behavioral health", "salud conductual"], ["mental health", "salud mental"], ["primary care", "atención primaria"],
  ["community health", "salud comunitaria"], ["public health", "salud pública"], ["health insurance", "seguro médico"], ["coverage", "cobertura"],
  ["employment", "empleo"], ["employment services", "servicios de empleo"], ["job search", "búsqueda de empleo"], ["job placement", "colocación laboral"],
  ["career", "carrera profesional"], ["career development", "desarrollo profesional"], ["workforce", "fuerza laboral"], ["workforce development", "desarrollo de la fuerza laboral"],
  ["training", "capacitación"], ["resume", "currículum"], ["interview", "entrevista"], ["networking", "creación de contactos"], ["employment opportunities", "oportunidades de empleo"],
  ["education", "educación"], ["adult education", "educación para adultos"], ["English-language", "de idioma inglés"], ["English learning", "aprendizaje de inglés"],
  ["literacy", "alfabetización"], ["homework", "tareas escolares"], ["learning resources", "recursos de aprendizaje"], ["career preparation", "preparación profesional"],
  ["vocational training", "capacitación vocacional"], ["technical education", "educación técnica"], ["transportation", "transporte"], ["public transportation", "transporte público"],
  ["bus routes", "rutas de autobús"], ["bus transportation", "transporte en autobús"], ["light-rail", "tren ligero"], ["accessible transportation", "transporte accesible"],
  ["utility assistance", "ayuda para servicios públicos"], ["utility-payment assistance", "ayuda para el pago de servicios públicos"], ["energy costs", "costos de energía"],
  ["energy-saving", "ahorro de energía"], ["water customers", "clientes de agua"], ["water assistance", "ayuda para el agua"], ["weatherization", "acondicionamiento energético"],
  ["basic-needs", "necesidades básicas"], ["basic needs", "necesidades básicas"], ["financial assistance", "ayuda financiera"], ["case-management", "gestión de casos"],
  ["information", "información"], ["including", "incluyendo"], ["including", "incluye"], ["and", "y"], ["or", "o"], ["for", "para"], ["with", "con"], ["from", "de"], ["through", "a través de"], ["by", "por"], ["to", "para"],
  ["the", "el"], ["a", "un"], ["an", "un"], ["of", "de"], ["in", "en"], ["on", "en"], ["at", "en"], ["may", "puede"], ["can", "puede"], ["helps", "ayuda a"], ["help", "ayuda"],
  ["connects", "conecta"], ["connecting", "conectando"], ["providing", "que ofrece"], ["provides", "ofrece"], ["offers", "ofrece"], ["focused on", "centrado en"], ["designed to", "diseñado para"],
  ["eligible low-income", "de bajos ingresos que cumplen los requisitos"], ["low-income", "de bajos ingresos"], ["financial eligibility", "elegibilidad financiera"],
  ["identification", "identificación"], ["residence", "residencia"], ["income", "ingresos"], ["documents", "documentos"], ["documentation", "documentación"], ["proof", "comprobante"],
  ["Prepare", "Prepara"], ["Bring", "Lleva"], ["Review", "Revisa"], ["complete", "completa"], ["follow", "sigue"], ["select", "selecciona"], ["enter", "ingresa"],
  ["before visiting", "antes de visitar"], ["before traveling", "antes de viajar"], ["when required", "cuando sea necesario"], ["when relevant", "cuando corresponda"], ["specific", "específico"], ["current requirements", "requisitos actuales"],
  ["hours", "horarios"], ["cost", "costo"], ["languages", "idiomas"], ["English, Spanish", "Inglés, Español"], ["English", "Inglés"], ["Spanish", "Español"],
  ["Free", "Gratis"], ["low-cost", "de bajo costo"], ["Monthly", "Mensuales"], ["Free screening tool", "Herramienta gratuita de evaluación"], ["Search for", "Busca"], ["Searchable directory", "Directorio con búsqueda"],
  ["United States", "Estados Unidos"], ["State", "Estado"], ["County", "Condado"], ["Area", "Área"], ["Arizona", "Arizona"], ["Phoenix", "Phoenix"], ["Mesa", "Mesa"], ["Tempe", "Tempe"],
  ["Use", "Utiliza"], ["official", "oficial"], ["site", "sitio"], ["call", "llama"], ["website", "sitio web"], ["Check", "Consulta"], ["eligible", "que cumplen los requisitos"],
  ["determined", "determinado"], ["depends", "depende"], ["specific program", "programa específico"], ["provider", "proveedor"], ["organization", "organización"], ["program-specific", "específico del programa"],
  ["No separate", "No se requiere una"], ["is required", "es necesario"], ["is available", "está disponible"], ["available", "disponible"], ["participating", "participantes"],
  ["Digital", "Digital"], ["online", "en línea"], ["Online", "En línea"], ["portal", "portal"], ["directory", "directorio"], ["location", "ubicación"], ["locations", "ubicaciones"]
];
ES_PHRASES.sort((a,b)=>b[0].length-a[0].length);
function translateToSpanish(text){
  let out=String(text??"");
  for(const [en,es] of ES_PHRASES){
...
function makeResource(id, category, name, description, website, location = "Arizona", phone = "Check website", cost = "Free or low-cost", spanish = true, free = true, access = "") {
  ...
  return { id, category, name:{en:name,es:name}, description:{en:description,es:translateToSpanish(description)}, access:{en:enAccess,es:translateToSpanish(enAccess)}, eligibility:{en:enEligibility,es:translateToSpanish(enEligibility)}, documents:{en:enDocuments,es:translateToSpanish(enDocuments)}, location, phone, hours:detail.hours||"Check official website", cost:{en:cost,es:translateToSpanish(cost)}, languages:spanish?"English, Spanish":"English", spanish, free, website, directionsQuery:detail.directionsQuery||`${name}, ${location}`, city:location.split(",")[0].trim(), zips:detail.zips||[] };
}
...
function createResourceCard(r){
  ...
  return `<article class="resource-card ${local?"zip-match":""}" data-resource-id="${r.id}"><div class="card-top"><div><div class="category-label">${escapeHTML(categoryLabels[l][r.category])}</div><h3>${escapeHTML(r.name[l])}</h3></div><div class="badges">${r.free?`<span class="badge blue">${l==="en"?"Free / low-cost":"Gratis / bajo costo"}</span>`:""}${r.spanish?`<span class="badge">${l==="en"?"Spanish available":"Español disponible"}</span>`:""}${near}</div></div><p class="resource-description">${escapeHTML(r.description[l])}</p><div class="details"><div class="detail"><strong>${l==="en"?"Location":"Ubicación"}</strong><span>${escapeHTML(r.location)}</span></div><div class="detail"><strong>${l==="en"?"Phone":"Teléfono"}</strong><span>${phone}</span></div><div class="detail"><strong>${l==="en"?"Hours":"Horario"}</strong><span>${escapeHTML(l==="en"?r.hours:translateToSpanish(r.hours))}</span></div><div class="detail"><strong>${l==="en"?"Cost":"Costo"}</strong><span>${escapeHTML(r.cost?.[l]??translateToSpanish(r.cost))}</span></div><div class="detail"><strong>${l==="en"?"Languages":"Idiomas"}</strong><span>${escapeHTML(l==="en"?r.languages:translateToSpanish(r.languages))}</span></div></div><div class="access-box"><strong>${l==="en"?"How to access":"Cómo acceder"}</strong><p>${escapeHTML(r.access[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Eligibility":"Requisitos"}:</b> ${escapeHTML(r.eligibility[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Documents":"Documentos"}:</b> ${escapeHTML(r.documents[l])}</p></div><div class="card-actions"><a class="visit" href="${w}" target="_blank" rel="noopener noreferrer">${l==="en"?"Visit website":"Visitar sitio"} ↗</a><a class="directions" href="${d}" target="_blank" rel="noopener noreferrer">${l==="en"?"Directions":"Direcciones"} ↗</a></div></article>`;
}
