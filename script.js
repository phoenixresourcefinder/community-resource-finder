...
/* =========================================================
   ...
   Official organization names are kept unchanged. User-facing
   descriptions, access instructions, eligibility, documents,
   labels, hours, costs, and language names are translated.
========================================================= */
const ES_PHRASES = [
  ["Emergency food boxes, food distributions, and hunger-relief services.", "Cajas de alimentos de emergencia, distribuciones de alimentos y servicios de ayuda contra el hambre."],
  ["Statewide directory connecting residents with food banks, pantries, and meal programs.", "Directorio estatal que conecta a los residentes con bancos de alimentos, despensas y programas de comidas."],
  ["Nutrition assistance for eligible low-income households.", "Asistencia nutricional para hogares de bajos ingresos que cumplen los requisitos."],
  ["Nutrition assistance, healthy foods, breastfeeding support, and nutrition education.", "Asistencia nutricional, alimentos saludables, apoyo para la lactancia y educación nutricional."],
  ["Helps SNAP shoppers get more fresh fruits and vegetables at participating locations.", "Ayuda a las personas que usan SNAP a obtener más frutas y verduras frescas en establecimientos participantes."],
  ["Food assistance and community support for Phoenix-area residents.", "Asistencia alimentaria y apoyo comunitario para residentes del área de Phoenix."],
  ["Food assistance, meals, and support for people experiencing hardship.", "Asistencia alimentaria, comidas y apoyo para personas que enfrentan dificultades económicas."],
  ["Food, meals, and basic-needs assistance.", "Alimentos, comidas y asistencia para necesidades básicas."],
  ["Meals and supportive services for people experiencing homelessness or hardship.", "Comidas y servicios de apoyo para personas que viven sin vivienda o enfrentan dificultades."],
  ["Community assistance including food and family support.", "Asistencia comunitaria que incluye alimentos y apoyo para las familias."],
  ["Food bank serving communities throughout central and eastern Arizona.", "Banco de alimentos que atiende a comunidades de Arizona central y oriental."],
  ["Food assistance and emergency support for Chandler-area households.", "Asistencia alimentaria y apoyo de emergencia para hogares del área de Chandler."],
  ["Food assistance and community programs for families in the Phoenix area.", "Asistencia alimentaria y programas comunitarios para familias del área de Phoenix."],
  ["Food pantry services for eligible Tempe-area households.", "Servicios de despensa de alimentos para hogares del área de Tempe que cumplen los requisitos."],
  ["Emergency food assistance distributed through participating organizations.", "Asistencia alimentaria de emergencia distribuida por organizaciones participantes."],
  ["Monthly food packages for eligible older adults.", "Paquetes mensuales de alimentos para adultos mayores que cumplen los requisitos."],
  ["Meal programs and nutrition support for eligible older adults.", "Programas de comidas y apoyo nutricional para adultos mayores que cumplen los requisitos."],
  ["Food and basic-needs assistance through community programs.", "Alimentos y asistencia para necesidades básicas mediante programas comunitarios."],
  ["Emergency food and community assistance.", "Asistencia alimentaria de emergencia y apoyo comunitario."],
  ["Community food access and nutrition programs in Phoenix.", "Programas comunitarios de acceso a alimentos y nutrición en Phoenix."],
  ["Food pantry and community assistance programs.", "Programas de despensa de alimentos y asistencia comunitaria."],
  ["Food assistance with culturally appropriate food options.", "Asistencia alimentaria con opciones de alimentos culturalmente apropiadas."],
  ["Mobile fresh-produce market connecting Phoenix neighborhoods with affordable produce.", "Mercado móvil de productos frescos que conecta a los vecindarios de Phoenix con productos a precios accesibles."],
  ["Free screening tool for Arizona health and human-services programs.", "Herramienta gratuita para determinar posibles beneficios de programas de salud y servicios humanos de Arizona."],
  ["National food-assistance referral service.", "Servicio nacional de referencia para asistencia alimentaria."],
  ["City directory connecting residents with food banks, nutrition programs, and food resources.", "Directorio municipal que conecta a los residentes con bancos de alimentos, programas de nutrición y recursos alimentarios."],
  ["Food assistance information and local food providers.", "Información sobre asistencia alimentaria y proveedores locales de alimentos."],
  ["Local food pantry and emergency food information.", "Información sobre despensas locales y alimentos de emergencia."],
  ["Fresh-produce assistance for eligible older adults.", "Asistencia para obtener productos frescos para adultos mayores que cumplen los requisitos."],
  ["Nutrition benefits supporting access to fresh produce.", "Beneficios nutricionales que ayudan a obtener productos frescos."],
  ["Search for food banks, pantries, soup kitchens, and emergency food providers.", "Busca bancos de alimentos, despensas, comedores y proveedores de alimentos de emergencia."],
  ["Arizona food-assistance information including SNAP and related programs.", "Información de Arizona sobre asistencia alimentaria, incluido SNAP y programas relacionados."],
  ["Searchable directory for food pantries, meals, and food delivery.", "Directorio con búsqueda de despensas, comidas y entrega de alimentos."],
  ["City resource guide covering food assistance, SNAP, WIC, senior meals, and community food partners.", "Guía municipal de recursos que incluye asistencia alimentaria, SNAP, WIC, comidas para adultos mayores y organizaciones comunitarias de alimentos."],
  ["Statewide information about nutrition programs and emergency food resources.", "Información estatal sobre programas de nutrición y recursos de alimentos de emergencia."],
  ["Affordable housing, rental assistance, housing programs, and homelessness resources.", "Vivienda asequible, asistencia para el alquiler, programas de vivienda y recursos para personas sin vivienda."],
  ["State housing resources, affordable housing programs, and housing assistance.", "Recursos estatales de vivienda, programas de vivienda asequible y asistencia de vivienda."],
  ["Searchable directory of affordable and accessible rental housing.", "Directorio con búsqueda de viviendas de alquiler asequibles y accesibles."],
  ["Connects residents with shelter, rental assistance, and housing programs.", "Conecta a los residentes con refugios, asistencia para el alquiler y programas de vivienda."],
  ["Affordable housing and supportive housing services.", "Vivienda asequible y servicios de vivienda con apoyo."],
  ["Shelter, housing, family support, and homelessness services.", "Refugio, vivienda, apoyo familiar y servicios para personas sin vivienda."],
  ["Affordable housing and supportive services.", "Vivienda asequible y servicios de apoyo."],
  ["Housing and family-stability services.", "Servicios de vivienda y estabilidad familiar."],
  ["Housing and economic-development services.", "Servicios de vivienda y desarrollo económico."],
  ["Free or low-cost legal assistance including housing and eviction matters.", "Asistencia legal gratuita o de bajo costo, incluidos asuntos de vivienda y desalojo."],
  ["Housing, homelessness, and community-support information.", "Información sobre vivienda, personas sin hogar y apoyo comunitario."],
  ["Resource navigation for people experiencing homelessness.", "Orientación para encontrar recursos para personas que viven sin vivienda."],
  ["Fair-housing education, advocacy, and assistance.", "Educación, defensa y asistencia relacionada con la vivienda justa."],
  ["Local agencies providing housing, emergency, employment, and self-sufficiency services.", "Agencias locales que ofrecen servicios de vivienda, emergencia, empleo y autosuficiencia."],
  ["Statewide housing resources and current housing-program information.", "Recursos estatales de vivienda e información actual sobre programas de vivienda."],
  ["City information connecting residents with housing and emergency-support programs.", "Información municipal que conecta a los residentes con programas de vivienda y apoyo de emergencia."],
  ["Information about shelter, homelessness programs, and supportive services.", "Información sobre refugios, programas para personas sin vivienda y servicios de apoyo."],
  ["Information about current state and local housing-assistance opportunities.", "Información sobre las oportunidades actuales de asistencia de vivienda estatales y locales."],
  ["Information about rental rights and responsibilities.", "Información sobre los derechos y responsabilidades de los inquilinos y propietarios."],
  ["Legal information and assistance for eligible Phoenix residents facing housing issues.", "Información y asistencia legal para residentes de Phoenix que cumplen los requisitos y enfrentan problemas de vivienda."],
  ["Information about programs that may help eligible residents repair or maintain homes.", "Información sobre programas que pueden ayudar a residentes que cumplen los requisitos a reparar o mantener sus viviendas."],
  ["Programs designed to improve energy efficiency and reduce household energy costs.", "Programas diseñados para mejorar la eficiencia energética y reducir los costos de energía del hogar."],
  ["Search for shelters and housing programs by location.", "Busca refugios y programas de vivienda por ubicación."],
  ["Mesa information covering housing, utilities, food, and other essential services.", "Información de Mesa sobre vivienda, servicios públicos, alimentos y otros servicios esenciales."],
  ["Current state housing publications, programs, income limits, and housing resources.", "Publicaciones estatales actuales sobre vivienda, programas, límites de ingresos y recursos de vivienda."],
  ["Arizona's Medicaid program for eligible residents.", "Programa de Medicaid de Arizona para residentes que cumplen los requisitos."],
  ["Community medical, dental, behavioral-health, and family services.", "Servicios comunitarios médicos, dentales, de salud conductual y familiares."],
  ["Community health centers providing affordable healthcare services.", "Centros de salud comunitarios que ofrecen servicios de atención médica asequibles."],
  ["Community primary and behavioral healthcare.", "Atención primaria y de salud conductual comunitaria."],
  ["Affordable medical, dental, and behavioral healthcare.", "Atención médica, dental y de salud conductual asequible."],
  ["Community health, behavioral health, and family services.", "Servicios comunitarios de salud, salud conductual y apoyo familiar."],
  ["Public health system providing hospital, primary, behavioral, and specialty care.", "Sistema público de salud que ofrece atención hospitalaria, primaria, de salud conductual y especializada."],
  ["Primary care, behavioral health, and community healthcare services.", "Servicios de atención primaria, salud conductual y atención médica comunitaria."],
  ["Healthcare services focused on people experiencing homelessness.", "Servicios de atención médica enfocados en personas que viven sin vivienda."],
  ["Community healthcare for people facing barriers to traditional care.", "Atención médica comunitaria para personas que enfrentan barreras para acceder a la atención tradicional."],
  ["Directory of Arizona clinics offering free or low-cost services.", "Directorio de clínicas de Arizona que ofrecen servicios gratuitos o de bajo costo."],
  ["Directory and information connecting residents with community health centers.", "Directorio e información que conectan a los residentes con centros de salud comunitarios."],
  ["Online application portal for Arizona healthcare and nutrition programs.", "Portal de solicitud en línea para programas de atención médica y nutrición de Arizona."],
  ["Health insurance marketplace and financial-assistance information.", "Mercado de seguros médicos e información sobre asistencia financiera."],
  ["National directory for finding community health centers.", "Directorio nacional para encontrar centros de salud comunitarios."],
  ["Community healthcare services in Phoenix.", "Servicios de atención médica comunitaria en Phoenix."],
  ["Healthcare services for people facing financial or insurance barriers.", "Servicios de atención médica para personas que enfrentan barreras económicas o de seguro."],
  ["Free healthcare and dental services through community programs.", "Servicios médicos y dentales gratuitos mediante programas comunitarios."],
  ["Public-health clinics, prevention, immunizations, and community health programs.", "Clínicas de salud pública, prevención, vacunación y programas de salud comunitaria."],
  ["Free assistance navigating health insurance and coverage options.", "Asistencia gratuita para orientarse entre las opciones de seguro y cobertura médica."],
  ["Healthcare services through the Indian Health Service.", "Servicios de atención médica a través del Indian Health Service."],
  ["Family, child-development, early-intervention, and community support.", "Apoyo familiar, desarrollo infantil, intervención temprana y apoyo comunitario."],
  ["Information, support, and advocacy for families of children with disabilities.", "Información, apoyo y defensa para familias de niños con discapacidades."],
  ["Early-intervention services for eligible young children.", "Servicios de intervención temprana para niños pequeños que cumplen los requisitos."],
  ["Family-focused behavioral-health and support services.", "Servicios de salud conductual y apoyo centrados en la familia."],
  ["Behavioral-health, recovery, housing, and supportive services.", "Servicios de salud conductual, recuperación, vivienda y apoyo."],
  ["Behavioral-health and community-support programs.", "Programas de salud conductual y apoyo comunitario."],
  ["Behavioral health, rehabilitation, and supportive services.", "Salud conductual, rehabilitación y servicios de apoyo."],
  ["Behavioral-health, family, and community services.", "Servicios de salud conductual, familiares y comunitarios."],
  ["Community healthcare services through NOAH.", "Servicios de atención médica comunitaria a través de NOAH."],
  ["Primary and behavioral healthcare.", "Atención primaria y de salud conductual."],
  ["Community healthcare through the NOAH network.", "Atención médica comunitaria a través de la red NOAH."],
  ["Community medical, dental, and behavioral-health services.", "Servicios comunitarios médicos, dentales y de salud conductual."],
  ["Affordable community healthcare services.", "Servicios comunitarios de atención médica asequibles."],
  ["Community healthcare services including pediatric care.", "Servicios comunitarios de atención médica, incluida la atención pediátrica."],
  ["Community health-center services in central Phoenix.", "Servicios de centro de salud comunitario en el centro de Phoenix."],
  ["Community healthcare services in north Phoenix.", "Servicios de atención médica comunitaria en el norte de Phoenix."],
  ["Community healthcare and behavioral-health services.", "Servicios comunitarios de atención médica y salud conductual."],
  ["Community healthcare services in south Phoenix.", "Servicios de atención médica comunitaria en el sur de Phoenix."],
  ["Primary and behavioral healthcare services.", "Servicios de atención primaria y salud conductual."],
  ["Community healthcare services.", "Servicios de atención médica comunitaria."],
  ["Free employment services, career counseling, job search, and training.", "Servicios gratuitos de empleo, orientación profesional, búsqueda de trabajo y capacitación."],
  ["Job search, resume, interview, and employment support.", "Apoyo para buscar trabajo, preparar el currículum, realizar entrevistas y encontrar empleo."],
  ["Employment services, career training, and job support.", "Servicios de empleo, capacitación profesional y apoyo laboral."],
  ["Employment assistance and job placement services.", "Asistencia para el empleo y servicios de colocación laboral."],
  ["Career development, education, and employment support.", "Desarrollo profesional, educación y apoyo para el empleo."],
  ["Employment, education, family, and community support.", "Apoyo para el empleo, la educación, las familias y la comunidad."],
  ["Career networking, workshops, and employment resources.", "Contactos profesionales, talleres y recursos de empleo."],
  ["Free technology training and career development.", "Capacitación tecnológica gratuita y desarrollo profesional."],
  ["Employment opportunities with the City of Phoenix.", "Oportunidades de empleo con la Ciudad de Phoenix."],
  ["Employment, workforce, and economic-opportunity programs.", "Programas de empleo, fuerza laboral y oportunidades económicas."],
  ["Workforce training, employment, and career services.", "Capacitación laboral, empleo y servicios profesionales."],
  ["Employment and career support for Mesa-area job seekers.", "Apoyo para el empleo y la carrera profesional para personas que buscan trabajo en el área de Mesa."],
  ["Employment and workforce information for Tempe residents.", "Información sobre empleo y fuerza laboral para residentes de Tempe."],
  ["Free screening tool connecting households with assistance programs.", "Herramienta gratuita de evaluación que conecta a los hogares con programas de asistencia."],
  ["Career preparation, employment, and training for eligible young people.", "Preparación profesional, empleo y capacitación para jóvenes que cumplen los requisitos."],
  ["Online employment and career resources.", "Recursos en línea de empleo y desarrollo profesional."],
  ["Employment resources and workforce services through Arizona DES.", "Recursos de empleo y servicios de fuerza laboral a través de Arizona DES."],
  ["Local agencies helping households secure and maintain employment.", "Agencias locales que ayudan a los hogares a conseguir y mantener el empleo."],
  ["Job placement and workforce assistance.", "Asistencia para la colocación laboral y la fuerza laboral."],
  ["Career preparation, employment support, and training.", "Preparación profesional, apoyo para el empleo y capacitación."],
  ["Career development and workforce support.", "Desarrollo profesional y apoyo a la fuerza laboral."],
  ["Workforce and employment support.", "Apoyo para la fuerza laboral y el empleo."],
  ["Workforce development and economic opportunity programs.", "Programas de desarrollo de la fuerza laboral y oportunidades económicas."],
  ["Free career events and networking opportunities.", "Eventos profesionales gratuitos y oportunidades para crear contactos."],
  ["Statewide employment and workforce information.", "Información estatal sobre empleo y fuerza laboral."],
  ["Adult education, high-school equivalency, ESL, and career preparation.", "Educación para adultos, equivalencia de preparatoria, inglés como segundo idioma y preparación profesional."],
  ["GED preparation, English learning, and adult education.", "Preparación para el GED, aprendizaje de inglés y educación para adultos."],
  ["Free computers, literacy programs, homework support, classes, and educational resources.", "Computadoras gratuitas, programas de alfabetización, apoyo con tareas, clases y recursos educativos."],
  ["Free literacy and English-learning programs for adults.", "Programas gratuitos de alfabetización y aprendizaje de inglés para adultos."],
  ["Free education and career training for eligible young people.", "Educación y capacitación profesional gratuitas para jóvenes que cumplen los requisitos."],
  ["Community-college education, certificates, degrees, and career programs.", "Educación de colegios comunitarios, certificados, títulos y programas profesionales."],
  ["Career and technical education, certificates, and degrees.", "Educación profesional y técnica, certificados y títulos."],
  ["English-language, education, family, and workforce programs.", "Programas de inglés, educación, apoyo familiar y fuerza laboral."],
  ["Education, career preparation, and training for eligible young people.", "Educación, preparación profesional y capacitación para jóvenes que cumplen los requisitos."],
  ["Early childhood education and family support.", "Educación de la primera infancia y apoyo familiar."],
  ["Statewide information about adult literacy and educational programs.", "Información estatal sobre alfabetización de adultos y programas educativos."],
  ["Homework and learning resources through Phoenix Public Library.", "Recursos para tareas y aprendizaje a través de Phoenix Public Library."],
  ["Free public computers and technology access.", "Computadoras públicas gratuitas y acceso a tecnología."],
  ["Literacy and educational programming.", "Programas de alfabetización y educación."],
  ["Adult education and high-school equivalency preparation.", "Educación para adultos y preparación para la equivalencia de preparatoria."],
  ["English-language learning for eligible adult students.", "Aprendizaje de inglés para estudiantes adultos que cumplen los requisitos."],
  ["English-language learning and adult education.", "Aprendizaje de inglés y educación para adultos."],
  ["Career-focused adult education.", "Educación para adultos enfocada en la carrera profesional."],
  ["Career and technical programs across Maricopa County.", "Programas profesionales y técnicos en todo el condado de Maricopa."],
  ["Certificate programs for career preparation.", "Programas de certificados para la preparación profesional."],
  ["Career and technical education programs.", "Programas de educación profesional y técnica."],
  ["Education and vocational training for eligible young people.", "Educación y capacitación vocacional para jóvenes que cumplen los requisitos."],
  ["Early childhood development, education, nutrition, and family support.", "Desarrollo infantil temprano, educación, nutrición y apoyo familiar."],
  ["English-language and educational programming.", "Programas de inglés y educación."],
  ["Statewide information about adult education and educational services.", "Información estatal sobre educación para adultos y servicios educativos."],
  ["Bus and light-rail transportation throughout the Phoenix metro area.", "Transporte en autobús y tren ligero en toda el área metropolitana de Phoenix."],
  ["Shared-ride transportation for eligible Phoenix residents with disabilities.", "Transporte compartido para residentes de Phoenix con discapacidades que cumplen los requisitos."],
  ["Accessible transportation for eligible riders.", "Transporte accesible para pasajeros que cumplen los requisitos."],
  ["Transportation option for eligible riders.", "Opción de transporte para pasajeros que cumplen los requisitos."],
  ["Connects residents with local transportation programs.", "Conecta a los residentes con programas locales de transporte."],
  ["Reduced transit fares for qualifying riders.", "Tarifas de transporte público reducidas para pasajeros que cumplen los requisitos."],
  ["Phoenix bus routes, transportation programs, and services.", "Rutas de autobús, programas y servicios de transporte de Phoenix."],
  ["Accessibility information for Phoenix public transportation.", "Información de accesibilidad para el transporte público de Phoenix."],
  ["Transportation assistance for eligible seniors.", "Asistencia de transporte para adultos mayores que cumplen los requisitos."],
  ["Transportation assistance connected with eligible NATIVE HEALTH services.", "Asistencia de transporte relacionada con servicios elegibles de NATIVE HEALTH."],
  ["Online public transportation trip-planning tool.", "Herramienta en línea para planificar viajes en transporte público."],
  ["Local and regional bus transportation.", "Transporte en autobús local y regional."],
  ["Light-rail transportation throughout the Phoenix area.", "Transporte en tren ligero en toda el área de Phoenix."],
  ["Accessibility and mobility information.", "Información sobre accesibilidad y movilidad."],
  ["Current public transportation fare information.", "Información actual sobre tarifas de transporte público."],
  ["City transportation programs and services.", "Programas y servicios de transporte de la ciudad."],
  ["Information and registration for accessible shared transportation.", "Información y registro para transporte compartido accesible."],
  ["Searchable transportation assistance directory.", "Directorio con búsqueda de asistencia de transporte."],
  ["Statewide information about transportation services.", "Información estatal sobre servicios de transporte."],
  ["Utility assistance for eligible low-income households.", "Asistencia para servicios públicos para hogares de bajos ingresos que cumplen los requisitos."],
  ["Arizona utility-assistance information.", "Información de Arizona sobre asistencia para servicios públicos."],
  ["Emergency assistance that may help households facing utility or basic-needs hardship.", "Asistencia de emergencia que puede ayudar a hogares que enfrentan dificultades con servicios públicos o necesidades básicas."],
  ["Financial assistance for eligible Phoenix water customers.", "Asistencia financiera para clientes de agua de Phoenix que cumplen los requisitos."],
  ["Utility assistance and bill-support programs.", "Asistencia para servicios públicos y programas de apoyo para pagar facturas."],
  ["Bill assistance and energy-support programs.", "Asistencia para pagar facturas y programas de apoyo energético."],
  ["Payment-assistance programs for eligible customers.", "Programas de asistencia para pagos para clientes que cumplen los requisitos."],
  ["Emergency community support that may include basic household needs.", "Apoyo comunitario de emergencia que puede incluir necesidades básicas del hogar."],
  ["Community assistance and support for households facing hardship.", "Asistencia y apoyo comunitario para hogares que enfrentan dificultades."],
  ["Emergency assistance that may include utility-related needs.", "Asistencia de emergencia que puede incluir necesidades relacionadas con servicios públicos."],
  ["Programs that can help eligible households reduce energy costs through weatherization.", "Programas que pueden ayudar a hogares que cumplen los requisitos a reducir los costos de energía mediante mejoras de eficiencia energética."],
  ["Mesa information about utility assistance and energy-saving programs.", "Información de Mesa sobre asistencia para servicios públicos y programas de ahorro de energía."],
  ["Utility-payment assistance and weatherization support.", "Asistencia para pagar servicios públicos y apoyo para mejoras de eficiencia energética."],
  ["Resource navigation and benefits assistance for older adults.", "Orientación para encontrar recursos y asistencia con beneficios para adultos mayores."],
  ["Searchable directory for utility and financial assistance.", "Directorio con búsqueda de asistencia para servicios públicos y ayuda financiera."],
  ["State utility-assistance information.", "Información estatal sobre asistencia para servicios públicos."],
  ["Housing-related energy-efficiency assistance.", "Asistencia de eficiencia energética relacionada con la vivienda."],
  ["City information about financial assistance for water customers.", "Información municipal sobre asistencia financiera para clientes de agua."],
  ["Emergency support and case-management resources.", "Apoyo de emergencia y recursos de gestión de casos."],
  ["Information about assistance programs for APS customers.", "Información sobre programas de asistencia para clientes de APS."],
  ["Information about SRP bill-assistance programs.", "Información sobre programas de asistencia para pagar facturas de SRP."],
  ["Information about gas-payment assistance.", "Información sobre asistencia para pagar el servicio de gas."],
  ["Local agencies providing utility, weatherization, and emergency assistance.", "Agencias locales que ofrecen asistencia para servicios públicos, eficiencia energética y emergencias."],
  ["Statewide search and referral information for assistance programs.", "Información estatal de búsqueda y referencias para programas de asistencia."],
  ["Statewide resource search for utility and other basic-needs assistance.", "Búsqueda estatal de recursos para asistencia con servicios públicos y otras necesidades básicas."],
]
const ES_MAP = new Map(ES_PHRASES);
function translateDescription(text){
  if(ES_MAP.has(text)) return ES_MAP.get(text);
  let x=text;
  const reps=[
    [/\bEmergency\b/g,"emergencia"],[/\bemergency\b/g,"emergencia"],[/\bfood\b/g,"alimentos"],[/\bFood\b/g,"Alimentos"],[/\bhousing\b/g,"vivienda"],[/\bHousing\b/g,"Vivienda"],[/\bhealthcare\b/g,"atención médica"],[/\bHealthcare\b/g,"Atención médica"],[/\bhealth\b/g,"salud"],[/\bHealth\b/g,"Salud"],[/\bbehavioral health\b/gi,"salud conductual"],[/\bemployment\b/g,"empleo"],[/\bEmployment\b/g,"Empleo"],[/\bworkforce\b/g,"fuerza laboral"],[/\beducation\b/g,"educación"],[/\bEducation\b/g,"Educación"],[/\btransportation\b/g,"transporte"],[/\bTransportation\b/g,"Transporte"],[/\butility assistance\b/gi,"asistencia para servicios públicos"],[/\butilities\b/gi,"servicios públicos"],[/\bcommunity\b/g,"comunitario"],[/\bCommunity\b/g,"Comunitario"],[/\bservices\b/g,"servicios"],[/\bservices\b/g,"servicios"],[/\bprograms\b/g,"programas"],[/\bprogram\b/g,"programa"],[/\bresidents\b/g,"residentes"],[/\bresident\b/g,"residente"],[/\bfamilies\b/g,"familias"],[/\bfamily\b/g,"familia"],[/\bsupport\b/g,"apoyo"],[/\bresources\b/g,"recursos"],[/\bfree\b/gi,"gratuito"],[/\baffordable\b/gi,"asequible"],[/\beligible\b/gi,"que cumplen los requisitos"],[/\beligible\b/gi,"que cumplen los requisitos"],[/\bArizona\b/g,"Arizona"],[/\bPhoenix\b/g,"Phoenix"],[/\bMesa\b/g,"Mesa"],[/\bTempe\b/g,"Tempe"],[/\bMaricopa County\b/g,"condado de Maricopa"],[/\bDirectory\b/g,"Directorio"],[/\binformation\b/g,"información"],[/\bInformation\b/g,"Información"],[/\bprograms and services\b/gi,"programas y servicios"],[/\band\b/g,"y"],[/\bfor\b/g,"para"],[/\bwith\b/g,"con"],[/\bthrough\b/g,"a través de"],[/\bincluding\b/g,"incluido"],[/\bto\b/g,"para"],[/\bin\b/g,"en"],[/\bof\b/g,"de"]
  ];
  for(const [a,b] of reps) x=x.replace(a,b);
  return x;
}
function translateAccess(text){
  let x=text;
  const reps=[
    [/Use the official (.+?) website or call (.+?) to confirm the current food-distribution site, hours, and intake procedure for (.+?)\. If the organization uses multiple sites, select the location serving your area before traveling\./i,
      (_,n,p,l)=>`Consulta el sitio web oficial de ${n} o llama al ${p} para confirmar el lugar actual de distribución de alimentos, el horario y el proceso de admisión para ${l}. Si la organización tiene varios lugares, selecciona el que atienda tu área antes de ir.`],
    [/Use the official (.+?) website or call (.+?) to confirm the current food-distribution site, hours, and intake procedure for (.+?)\./i,
      (_,n,p,l)=>`Consulta el sitio web oficial de ${n} o llama al ${p} para confirmar el lugar actual de distribución de alimentos, el horario y el proceso de admisión para ${l}.`],
    [/Apply through Arizona DES\/Health-e-Arizona Plus, complete the application and required interview, then submit the verification DES requests\. Use the linked DES nutrition-assistance page for the current application route\./i,
      "Solicita los beneficios mediante Arizona DES/Health-e-Arizona Plus, completa la solicitud y la entrevista obligatoria y entrega las verificaciones que DES solicite. Usa la página enlazada de asistencia nutricional de DES para consultar la vía de solicitud vigente."],
    [/Use the Arizona WIC participant portal linked above to complete the eligibility assessment, select an Arizona clinic, and follow the registration steps for the WIC appointment\./i,
      "Usa el portal de participantes de Arizona WIC enlazado arriba para completar la evaluación de elegibilidad, seleccionar una clínica de Arizona y seguir los pasos de registro para la cita de WIC."],
    [/Bring an active SNAP\/EBT card to a participating Double Up Arizona site; the program has separate procedures for farmers markets, grocery stores, CSAs, farm stands, mobile markets, and participating online sites\./i,
      "Lleva una tarjeta SNAP/EBT activa a un establecimiento participante de Double Up Arizona. El programa tiene procedimientos distintos para mercados de agricultores, supermercados, CSA, puestos agrícolas, mercados móviles y establecimientos participantes en línea."],
    [/Start with the official (.+?) site and follow its housing, shelter, rental, or legal-service intake instructions\. For (.+?) services, use the site or call (.+?) to confirm whether an appointment, referral, waitlist, or screening is required before visiting\./i,
      (_,n,l,p)=>`Comienza en el sitio oficial de ${n} y sigue sus instrucciones de admisión para vivienda, refugio, alquiler o servicios legales. Para los servicios de ${l}, usa el sitio o llama al ${p} para confirmar si necesitas cita, referencia, lista de espera o evaluación antes de acudir.`],
    [/Use the official (.+?) site to choose the appropriate clinic\/service and request an appointment or follow its patient-intake instructions\. Call (.+?) to confirm accepted insurance\/payment options, new-patient availability, and the correct (.+?) service point\./i,
      (_,n,p,l)=>`Usa el sitio oficial de ${n} para elegir la clínica o el servicio correspondiente y solicitar una cita o seguir sus instrucciones de admisión de pacientes. Llama al ${p} para confirmar los seguros y formas de pago aceptados, la disponibilidad para pacientes nuevos y el punto de servicio correcto en ${l}.`],
    [/Use the official (.+?) employment page to create\/apply for the relevant job, training, or workforce service\. Follow the organization's intake or registration steps and call (.+?) if the listing requires an appointment or local enrollment\./i,
      (_,n,p)=>`Usa la página oficial de empleo de ${n} para solicitar el trabajo, la capacitación o el servicio laboral correspondiente. Sigue los pasos de admisión o registro de la organización y llama al ${p} si el recurso requiere una cita o inscripción local.`],
    [/Open the official (.+?) program page, review the program-specific enrollment\/admission steps, and complete the required registration or application\. Call (.+?) to confirm placement, class availability, age requirements, or the correct (.+?) campus\./i,
      (_,n,p,loc)=>`Abre la página oficial del programa ${n}, revisa los pasos específicos de inscripción o admisión y completa el registro o la solicitud requeridos. Llama al ${p} para confirmar la colocación, la disponibilidad de clases, los requisitos de edad o el campus correcto de ${loc}.`],
    [/Use the official (.+?) page to plan, register, or request the transportation service\. If eligibility or advance reservation applies, complete that process before traveling; call (.+?) to confirm the pickup\/service area for (.+?)\./i,
      (_,n,p,l)=>`Usa la página oficial de ${n} para planificar, registrarte o solicitar el servicio de transporte. Si se requiere elegibilidad o reservación previa, completa ese proceso antes de viajar; llama al ${p} para confirmar el área de recogida o servicio para ${l}.`],
    [/Use the official (.+?) page to review the applicable assistance program and follow its application or customer-assistance instructions\. Have your account information available and call (.+?) to confirm current funding, service-area rules, and required intake steps\./i,
      (_,n,p)=>`Usa la página oficial de ${n} para revisar el programa de asistencia correspondiente y seguir sus instrucciones de solicitud o atención al cliente. Ten a mano la información de tu cuenta y llama al ${p} para confirmar los fondos disponibles, las reglas del área de servicio y los pasos de admisión requeridos.`],
    [/Open the linked directory, enter the household ZIP\/location, and select a currently listed food pantry or meal provider before traveling\./i,
      "Abre el directorio enlazado, introduce el código postal o la ubicación del hogar y selecciona una despensa de alimentos o proveedor de comidas que aparezca actualmente antes de ir."],
  ];
  for(const [a,b] of reps)x=x.replace(a,b);
  return x;
}
function translateEligibility(text){
  const exact={
    "Requires an active SNAP/EBT balance and use at a participating Double Up Arizona location; no separate Double Up application is required.":"Requiere un saldo activo en SNAP/EBT y usarlo en un establecimiento participante de Double Up Arizona; no se necesita una solicitud separada para Double Up.",
    "Arizona residents who are pregnant, recently pregnant, breastfeeding, infants, or children under age 5 may qualify; income/program participation and nutrition-risk rules apply.":"Pueden cumplir los requisitos los residentes de Arizona que estén embarazadas, hayan estado embarazadas recientemente, estén amamantando, sean bebés o sean niños menores de 5 años; se aplican las reglas de ingresos, participación en programas y riesgo nutricional.",
    "Arizona households are evaluated under SNAP/Nutrition Assistance rules, including household composition and financial eligibility; DES determines eligibility after application and interview.":"Los hogares de Arizona se evalúan según las reglas de SNAP/Asistencia Nutricional, incluida la composición del hogar y la elegibilidad financiera; DES determina la elegibilidad después de la solicitud y la entrevista.",
    "Designed for qualifying older adults; the specific program may use age, income, or existing participation in a senior food program to determine eligibility.":"Está diseñado para adultos mayores que cumplen los requisitos; el programa específico puede utilizar la edad, los ingresos o la participación existente en un programa de alimentos para adultos mayores para determinar la elegibilidad.",
    "Eligibility depends on the specific assistance program and provider; income, household size, service address, account status, past-due balance, and available funding may be considered.":"La elegibilidad depende del programa de asistencia y del proveedor específicos; pueden considerarse los ingresos, el tamaño del hogar, la dirección del servicio, el estado de la cuenta, el saldo vencido y los fondos disponibles.",
    "Eligibility depends on the specific transportation program; some services require disability/ADA eligibility, senior status, enrollment, geographic service-area rules, or advance registration.":"La elegibilidad depende del programa de transporte específico; algunos servicios requieren elegibilidad por discapacidad/ADA, condición de adulto mayor, inscripción, reglas del área geográfica de servicio o registro previo.",
    "Eligibility depends on the specific course or program at Arizona Adult Education; requirements may include age, prior education, residency, placement, or program-specific enrollment criteria.":"La elegibilidad depende del curso o programa específico de Arizona Adult Education; los requisitos pueden incluir edad, educación previa, residencia, colocación o criterios de inscripción específicos del programa.",
  }
  if(exact[text])return exact[text];
  let x=text;
  const reps=[
    [/^Eligibility depends on the food program and serving site operated or listed by (.+?); local pantry programs may use residence, household need, or income guidelines\.$/i,
      (_,n)=>`La elegibilidad depende del programa de alimentos y del lugar de servicio administrado o indicado por ${n}; las despensas locales pueden utilizar requisitos de residencia, necesidad del hogar o ingresos.`],
    [/^Eligibility is program-specific and may depend on household income, household size, housing status, disability\/age, residency, or the particular property\/program administered by (.+?)\.$/i,
      (_,n)=>`La elegibilidad es específica del programa y puede depender de los ingresos y tamaño del hogar, la situación de vivienda, la discapacidad o edad, la residencia o la propiedad o programa específico administrado por ${n}.`],
    [/^Eligibility and payment rules depend on the specific service at (.+?); patients may be served based on insurance, income\/sliding-fee rules, age, location, or program enrollment\.$/i,
      (_,n)=>`La elegibilidad y las reglas de pago dependen del servicio específico de ${n}; la atención puede basarse en el seguro, las reglas de tarifas según ingresos, la edad, la ubicación o la inscripción en el programa.`],
    [/^Eligibility depends on the specific employment or training service at (.+?); some programs may have age, residency, income, employment-status, or workforce-program requirements\.$/i,
      (_,n)=>`La elegibilidad depende del servicio específico de empleo o capacitación de ${n}; algunos programas pueden tener requisitos de edad, residencia, ingresos, situación laboral o participación en programas de fuerza laboral.`],
    [/^Eligibility depends on the specific healthcare service at (.+?); some services may have insurance, income, age, residency, clinic, or program-specific requirements\.$/i,
      (_,n)=>`La elegibilidad depende del servicio de atención médica específico de ${n}; algunos servicios pueden tener requisitos relacionados con seguro, ingresos, edad, residencia, clínica o programa.`],
    [/^Eligibility depends on the specific course or program at (.+?); requirements may include age, prior education, residency, placement, or program-specific enrollment criteria\.$/i,
      (_,n)=>`La elegibilidad depende del curso o programa específico de ${n}; los requisitos pueden incluir edad, educación previa, residencia, colocación o criterios de inscripción específicos del programa.`],
  ];
  for(const [a,b] of reps)x=x.replace(a,b);
  return x;
}
function translateDocuments(text){
  let x=text;
  const exact={
    "Bring an active SNAP/EBT card with an available balance; participating locations may use their own checkout or token/voucher procedure.":"Lleva una tarjeta SNAP/EBT activa con saldo disponible; los establecimientos participantes pueden utilizar su propio procedimiento de pago, fichas o vales.",
    "For the WIC appointment, prepare household/member information, Arizona residence information, and any documents requested through the WIC eligibility/clinic registration process; the clinic will identify additional verification needed.":"Para la cita de WIC, prepara la información del hogar y de sus integrantes, información de residencia en Arizona y cualquier documento solicitado durante el proceso de elegibilidad o registro de la clínica; la clínica indicará qué verificaciones adicionales se necesitan.",
  }
  if(exact[text])return exact[text];
  const reps=[
    [/^Bring the identification or residence\/income documentation requested by the specific pantry or food program; requirements vary by distribution site\. Do not assume digital copies are accepted\.$/i,"Lleva la identificación o los documentos de residencia o ingresos que solicite la despensa o el programa de alimentos específico; los requisitos varían según el lugar de distribución. No des por hecho que aceptan copias digitales."],
    [/^Prepare identity\/citizenship or lawful-status verification as applicable, Social Security information for applicants, household\/income records, and—when relevant—rent\/mortgage, utility, childcare, medical, and child-support expense verification\.$/i,"Prepara comprobantes de identidad o ciudadanía o de estatus migratorio cuando correspondan, información del Seguro Social de los solicitantes, registros del hogar y de ingresos y, cuando corresponda, comprobantes de alquiler o hipoteca, servicios públicos, cuidado infantil, gastos médicos y manutención infantil."],
    [/^Prepare government-issued ID, household member information, income\/benefit verification, current lease or housing information, and any eviction\/homelessness documentation that applies to the program; the provider may request additional documents\.$/i,"Prepara una identificación emitida por el gobierno, información de los integrantes del hogar, comprobantes de ingresos o beneficios, el contrato de alquiler actual o información de vivienda y cualquier documento sobre desalojo o falta de vivienda que corresponda al programa; el proveedor puede solicitar documentos adicionales."],
    [/^Prepare photo ID, insurance\/AHCCCS information if applicable, contact information, medication\/medical history, and income documentation if the clinic uses a sliding-fee program\. Bring only the documents the clinic requests\.$/i,"Prepara una identificación con fotografía, información del seguro o de AHCCCS si corresponde, datos de contacto, información de medicamentos o antecedentes médicos y comprobantes de ingresos si la clínica utiliza un programa de tarifas según ingresos. Lleva únicamente los documentos que la clínica solicite."],
    [/^Prepare photo ID, insurance\/AHCCCS information if applicable, contact information, medication\/medical history, and income documentation if the clinic uses a sliding-fee program\. Bring any referral or authorization the specific service requires\.$/i,
      "Prepara una identificación con fotografía, información del seguro o de AHCCCS si corresponde, datos de contacto, información de medicamentos o antecedentes médicos y comprobantes de ingresos si la clínica utiliza tarifas según ingresos. Lleva cualquier referencia o autorización que requiera el servicio específico."],
    [/^Prepare a current resume if available, government-issued ID\/work-authorization documents when required for employment, contact information, education\/training records, and any program-specific eligibility documentation\.$/i,"Prepara un currículum actualizado si lo tienes, una identificación emitida por el gobierno y documentos de autorización de trabajo cuando sean necesarios para el empleo, información de contacto, registros de educación o capacitación y cualquier documento de elegibilidad específico del programa."],
    [/^Prepare photo ID, proof of residency when required, prior school\/GED transcripts or placement information when applicable, and any program-specific enrollment documents\. Do not submit original documents unless the institution specifically requires them\.$/i,"Prepara una identificación con fotografía, comprobante de residencia cuando se requiera, expedientes escolares o del GED anteriores o información de colocación cuando corresponda y cualquier documento de inscripción específico del programa. No entregues documentos originales a menos que la institución los solicite específicamente."],
    [/^Prepare photo ID and the information required for registration; ADA\/paratransit services may require an eligibility application or certification, while reduced-fare programs may require age, disability, student, or income verification\.$/i,"Prepara una identificación con fotografía y la información necesaria para el registro; los servicios ADA o de paratránsito pueden requerir una solicitud o certificación de elegibilidad, mientras que los programas de tarifa reducida pueden requerir comprobantes de edad, discapacidad, condición de estudiante o ingresos."],
    [/^Prepare a current utility bill\/account number, service address, household income information, photo ID, and any past-due\/disconnection notice or benefit documentation requested by the assistance program\.$/i,"Prepara una factura reciente de servicios públicos o el número de cuenta, la dirección del servicio, información sobre los ingresos del hogar, una identificación con fotografía y cualquier aviso de saldo vencido o desconexión o comprobante de beneficios que solicite el programa de asistencia."],
  ]
  for(const [a,b] of reps)x=x.replace(a,b);
  return x;
}
function translateMeta(text, type){
  text=String(text ?? '');
  if(type==='cost') return text.replace(/^Free or low-cost$/i,'Gratis o de bajo costo').replace(/^Free$/i,'Gratis');
  if(type==='hours') return text.replace(/^Check official website$/i,'Consulta el sitio oficial').replace(/^Check website$/i,'Consulta el sitio web');
  if(type==='languages') return text.replace(/English, Spanish/g,'Inglés, español').replace(/^English$/,'Inglés');
  return text;
}
...
function makeResource(id, category, name, description, website, location = "Arizona", phone = "Check website", cost = "Free or low-cost", spanish = true, free = true, access = "") {
  ...
  const enAccess=access||detail.access||"Use the official website linked above for current intake instructions."; const enEligibility=detail.eligibility||"Eligibility is determined by the specific program; confirm current requirements with the organization."; const enDocuments=detail.documents||"Review the official website for the current document checklist."; const enHours=detail.hours||"Check official website"; const esAccess=translateAccess(enAccess); const esEligibility=translateEligibility(enEligibility); const esDocuments=translateDocuments(enDocuments); return { id, category, name:{en:name,es:name}, description:{en:description,es:translateDescription(description)}, access:{en:enAccess,es:esAccess}, eligibility:{en:enEligibility,es:esEligibility}, documents:{en:enDocuments,es:esDocuments}, location, phone, hours:{en:enHours,es:translateMeta(enHours,"hours")}, cost:{en:cost,es:translateMeta(cost,"cost")}, languages:{en:spanish?"English, Spanish":"English",es:spanish?"Inglés, español":"Inglés"}, spanish, free, website, directionsQuery:detail.directionsQuery||`${name}, ${location}`, city:location.split(",")[0].trim(), zips:detail.zips||[] };
}
...
function findByZip(){
  ...
  i.value=z;
  if(!/^\d{5}$/.test(z)){
    document.getElementById("zipMessage").textContent=currentLanguage==="en"
  ...
  document.getElementById("zipMessage").textContent=localCount
    ? (currentLanguage==="en"
      ? `ZIP ${z} matched ${localCount} local/area resources serving ${area}. Turn on “Include statewide resources” for Arizona-wide programs too.`
      : `El código ${z} coincide con ${localCount} recursos locales/de área que sirven a ${area}. Activa “Incluir recursos estatales” para ver también programas de todo Arizona.`)
    : (currentLanguage==="en"
      ? `No specifically local listings were found for ZIP ${z}. Showing statewide resources that may serve your area.`
      : `No se encontraron recursos específicamente locales para el código ${z}. Mostrando recursos estatales que pueden servir a tu área.`);
  renderResources();
...
function renderResources(){
  const q=document.getElementById("search").value.trim().toLowerCase(),
    free=document.getElementById("freeFilter").checked,
    es=document.getElementById("spanishFilter").checked,
    statewide=document.getElementById("statewideFilter")?.checked||false;
  ...
  let f=resources.filter(r=>{
    ...
    const hay=[r.name.en,r.name.es,r.description.en,r.description.es,r.location,r.category,
      r.access.en,r.access.es,r.eligibility.en,r.eligibility.es,r.documents.en,r.documents.es]
      .join(" ").toLowerCase();
  ...
  updateDirectoryStatus(f.length, localCount, statewide);
}

function updateDirectoryStatus(count, localCount, statewide){
  const el=document.getElementById("directoryStatusText");
  if(!el)return;
  if(currentZip){
    if(localCount>0){
      el.textContent=currentLanguage==="en"
        ? `Showing ${localCount} local/area resources for ZIP ${currentZip}${statewide?" plus statewide programs":""}.`
        : `Mostrando ${localCount} recursos locales/de área para el código ${currentZip}${statewide?" más programas estatales":""}.`;
    }else{
      el.textContent=currentLanguage==="en"
        ? `No local listings matched ZIP ${currentZip}; showing statewide programs that may serve your area.`
        : `No hubo listados locales para el código ${currentZip}; mostrando programas estatales que pueden servir a tu área.`;
    }
  }else{
    el.textContent=currentLanguage==="en"
      ? `Showing ${count} resources across Arizona.`
      : `Mostrando ${count} recursos en Arizona.`;
  }
}
...
function createResourceCard(r){
  ...
  return `<article class="resource-card ${local?"zip-match":""}" data-resource-id="${r.id}"><div class="card-top"><div><div class="category-label">${escapeHTML(categoryLabels[l][r.category])}</div><h3>${escapeHTML(r.name[l])}</h3></div><div class="badges">${r.free?`<span class="badge blue">${l==="en"?"Free / low-cost":"Gratis / bajo costo"}</span>`:""}${r.spanish?`<span class="badge">${l==="en"?"Spanish available":"Español disponible"}</span>`:""}${near}</div></div><p class="resource-description">${escapeHTML(r.description[l])}</p><div class="details"><div class="detail"><strong>${l==="en"?"Location":"Ubicación"}</strong><span>${escapeHTML(r.location)}</span></div><div class="detail"><strong>${l==="en"?"Phone":"Teléfono"}</strong><span>${phone}</span></div><div class="detail"><strong>${l==="en"?"Hours":"Horario"}</strong><span>${escapeHTML(r.hours[l])}</span></div><div class="detail"><strong>${l==="en"?"Cost":"Costo"}</strong><span>${escapeHTML(r.cost[l])}</span></div><div class="detail"><strong>${l==="en"?"Languages":"Idiomas"}</strong><span>${escapeHTML(r.languages[l])}</span></div></div><div class="access-box"><strong>${l==="en"?"How to access":"Cómo acceder"}</strong><p>${escapeHTML(r.access[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Eligibility":"Requisitos"}:</b> ${escapeHTML(r.eligibility[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Documents":"Documentos"}:</b> ${escapeHTML(r.documents[l])}</p></div><div class="card-actions"><a class="visit" href="${w}" target="_blank" rel="noopener noreferrer">${l==="en"?"Visit website":"Visitar sitio"} ↗</a><a class="directions" href="${d}" target="_blank" rel="noopener noreferrer">${l==="en"?"Directions":"Direcciones"} ↗</a></div></article>`;
}
...
function clearFilters(){
  ...
  document.getElementById("zipCode").removeAttribute("aria-invalid");
  document.getElementById("freeFilter").checked=false;
  document.getElementById("spanishFilter").checked=false;
  document.getElementById("statewideFilter").checked=false;
  currentZip="";
  currentCategory="all";
  document.querySelectorAll(".category-button").forEach(b=>b.classList.remove("active"));
  const all=[...document.querySelectorAll(".category-button")].find(b=>b.getAttribute("onclick")?.includes("setCategory('all'"));
...
function updateLanguage(){
  ...
  document.title=currentLanguage==="en"?"Community Resource Finder":"Buscador de Recursos Comunitarios";
  document.querySelectorAll("[data-en][data-es]").forEach(e=>e.textContent=e.dataset[currentLanguage]);
  document.querySelectorAll("[data-aria-en][data-aria-es]").forEach(e=>e.setAttribute("aria-label",e.dataset[`aria${currentLanguage==="en"?"En":"Es"}`]));
  const s=document.getElementById("search");
  if(s)s.placeholder=currentLanguage==="en"?s.dataset.placeholderEn:s.dataset.placeholderEs;
  const z=document.getElementById("zipCode");
  if(z)z.placeholder=currentLanguage==="en"?z.dataset.placeholderEn:z.dataset.placeholderEs;
  const lb=document.getElementById("languageButton");
  if(lb)lb.textContent=currentLanguage==="en"?"Español":"English";
  if(currentZip){
    document.getElementById("zipMessage").textContent=currentLanguage==="en"
      ? `Showing resources serving ${getZipArea(currentZip)} for ZIP ${currentZip}. Statewide programs are available when applicable.`
      : `Mostrando recursos que sirven a ${getZipArea(currentZip)} para el código ${currentZip}. Los programas estatales aparecen cuando corresponde.`;
  }
}
...
function helperCategory(c){
  closeHelper();
  const b=[...document.querySelectorAll(".category-button")].find(x=>x.getAttribute("onclick")?.includes(`'${c}'`));
  setCategory(c,b);
  document.getElementById("resources").scrollIntoView({behavior:"smooth",block:"start"});
}
...
document.addEventListener("DOMContentLoaded",()=>{
  const modal=document.getElementById("helperModal");
  if(modal)modal.addEventListener("click",e=>{if(e.target===modal)closeHelper();});

  document.addEventListener("keydown",e=>{
    if(e.key==="Escape")closeHelper();
    if(e.key==="Enter"&&document.activeElement?.id==="zipCode")findByZip();
  });
