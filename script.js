...
/*
   SPANISH CONTENT
   ---------------
   Spanish text is written as natural, complete Spanish rather than being
   produced by word-for-word substitution. Proper organization/program names
   remain unchanged.
*/
const ES_DESCRIPTIONS = {
  1: "Ofrece cajas de alimentos de emergencia, distribuciones de alimentos y servicios para combatir el hambre.",
  2: "Directorio estatal que conecta a los residentes con bancos de alimentos, despensas y programas de comidas.",
  3: "Ayuda alimentaria para hogares de bajos ingresos que cumplen los requisitos.",
  4: "Ayuda alimentaria, alimentos saludables, apoyo para la lactancia y educación nutricional.",
  5: "Ayuda a las personas que usan SNAP a obtener más frutas y verduras frescas en establecimientos participantes.",
  6: "Ayuda alimentaria y apoyo comunitario para residentes del área de Phoenix.",
  7: "Ayuda alimentaria, comidas y apoyo para personas que atraviesan dificultades.",
  8: "Alimentos, comidas y ayuda para necesidades básicas.",
  9: "Comidas y servicios de apoyo para personas que enfrentan falta de vivienda o dificultades.",
  10: "Ayuda comunitaria que incluye alimentos y apoyo para las familias.",
  11: "Banco de alimentos que atiende a comunidades del centro y este de Arizona.",
  12: "Ayuda alimentaria y apoyo de emergencia para hogares del área de Chandler.",
  13: "Ayuda alimentaria y programas comunitarios para familias del área de Phoenix.",
  14: "Servicios de despensa de alimentos para hogares del área de Tempe que cumplen los requisitos.",
  15: "Ayuda alimentaria de emergencia distribuida por organizaciones participantes.",
  16: "Paquetes mensuales de alimentos para adultos mayores que cumplen los requisitos.",
  17: "Programas de comidas y apoyo nutricional para adultos mayores que cumplen los requisitos.",
  18: "Ayuda alimentaria y para necesidades básicas mediante programas comunitarios.",
  19: "Ayuda alimentaria de emergencia y asistencia comunitaria.",
  20: "Programas comunitarios de acceso a alimentos y nutrición en Phoenix.",
  21: "Programas de despensa de alimentos y asistencia comunitaria.",
  22: "Ayuda alimentaria con opciones de alimentos culturalmente apropiadas.",
  23: "Mercado móvil de productos frescos que conecta a los vecindarios de Phoenix con productos a precios accesibles.",
  24: "Herramienta gratuita para evaluar la elegibilidad para programas de salud y servicios humanos de Arizona.",
  25: "Servicio nacional de referencia para encontrar ayuda alimentaria.",
  26: "Directorio de la ciudad que conecta a los residentes con bancos de alimentos, programas de nutrición y recursos alimentarios.",
  27: "Información sobre ayuda alimentaria y proveedores locales de alimentos.",
  28: "Información local sobre despensas de alimentos y ayuda alimentaria de emergencia.",
  29: "Ayuda para obtener productos frescos dirigida a adultos mayores que cumplen los requisitos.",
  30: "Beneficios de nutrición que facilitan el acceso a productos frescos.",
  31: "Busca bancos de alimentos, despensas, comedores comunitarios y proveedores de alimentos de emergencia.",
  32: "Información de Arizona sobre ayuda alimentaria, incluidos SNAP y programas relacionados.",
  33: "Directorio con búsqueda de despensas de alimentos, comidas y entrega de alimentos.",
  34: "Guía de recursos de la ciudad que incluye ayuda alimentaria, SNAP, WIC, comidas para adultos mayores y organizaciones comunitarias de alimentos.",
  35: "Información estatal sobre programas de nutrición y recursos de alimentos de emergencia.",
  36: "Vivienda asequible, ayuda para el alquiler, programas de vivienda y recursos para personas sin vivienda.",
  37: "Recursos estatales de vivienda, programas de vivienda asequible y ayuda para la vivienda.",
  38: "Directorio con búsqueda de viviendas de alquiler asequibles y accesibles.",
  39: "Conecta a los residentes con refugios, ayuda para el alquiler y programas de vivienda.",
  40: "Servicios de vivienda asequible y vivienda con apoyo.",
  41: "Refugio, vivienda, apoyo para familias y servicios para personas sin vivienda.",
  42: "Vivienda asequible y servicios de apoyo.",
  43: "Servicios de vivienda y apoyo para la estabilidad familiar.",
  44: "Servicios de vivienda y desarrollo económico.",
  45: "Asistencia legal gratuita o de bajo costo, incluidos asuntos de vivienda y desalojo.",
  46: "Información sobre vivienda, personas sin hogar y apoyo comunitario.",
  47: "Orientación sobre recursos para personas que enfrentan falta de vivienda.",
  48: "Educación, defensa y asistencia en materia de vivienda justa.",
  49: "Agencias locales que ofrecen servicios de vivienda, emergencia, empleo y autosuficiencia.",
  50: "Recursos estatales de vivienda e información actual sobre programas de vivienda.",
  51: "Información de la ciudad que conecta a los residentes con programas de vivienda y apoyo de emergencia.",
  52: "Información sobre refugios, programas para personas sin vivienda y servicios de apoyo.",
  53: "Información sobre oportunidades actuales de ayuda para la vivienda a nivel estatal y local.",
  54: "Información sobre los derechos y responsabilidades de propietarios e inquilinos.",
  55: "Información legal y asistencia para residentes de Phoenix que cumplen los requisitos y enfrentan problemas de vivienda.",
  56: "Información sobre programas que pueden ayudar a residentes que cumplen los requisitos a reparar o mantener sus viviendas.",
  57: "Programas diseñados para mejorar la eficiencia energética y reducir los costos de energía del hogar.",
  58: "Busca refugios y programas de vivienda por ubicación.",
  59: "Información de Mesa sobre vivienda, servicios públicos, alimentos y otros servicios esenciales.",
  60: "Publicaciones, programas, límites de ingresos y recursos de vivienda estatales actualizados.",
  61: "Programa de Medicaid de Arizona para residentes que cumplen los requisitos.",
  62: "Centros comunitarios que ofrecen servicios médicos, dentales, de salud conductual y para familias.",
  63: "Centros de salud comunitarios que ofrecen servicios de atención médica asequibles.",
  64: "Atención médica primaria y de salud conductual en la comunidad.",
  65: "Atención médica, dental y de salud conductual asequible.",
  66: "Servicios comunitarios de salud, salud conductual y apoyo para familias.",
  67: "Sistema público de salud que ofrece atención hospitalaria, primaria, conductual y especializada.",
  68: "Servicios comunitarios de atención primaria y salud conductual.",
  69: "Servicios de atención médica enfocados en personas que enfrentan falta de vivienda.",
  70: "Atención médica comunitaria para personas que enfrentan barreras para acceder a la atención tradicional.",
  71: "Directorio de clínicas de Arizona que ofrecen servicios gratuitos o de bajo costo.",
  72: "Directorio e información para conectar a los residentes con centros de salud comunitarios.",
  73: "Portal de solicitud en línea para programas de atención médica y nutrición de Arizona.",
  74: "Mercado de seguros médicos e información sobre ayuda financiera.",
  75: "Directorio nacional para encontrar centros de salud comunitarios.",
  76: "Servicios de atención médica comunitaria en Phoenix.",
  77: "Servicios de atención médica para personas que enfrentan barreras económicas o de seguro.",
  78: "Servicios gratuitos de atención médica y dental mediante programas comunitarios.",
  79: "Clínicas de salud pública, prevención, vacunación y programas de salud comunitaria.",
  80: "Asistencia gratuita para orientarse sobre seguros médicos y opciones de cobertura.",
  81: "Servicios de atención médica mediante el Servicio de Salud para Pueblos Indígenas.",
  82: "Servicios para familias, desarrollo infantil, intervención temprana y apoyo comunitario.",
  83: "Información, apoyo y defensa para familias de niños con discapacidades.",
  84: "Servicios de intervención temprana para niños pequeños que cumplen los requisitos.",
  85: "Servicios de salud conductual y apoyo centrados en las familias.",
  86: "Servicios de salud conductual, recuperación, vivienda y apoyo.",
  87: "Programas de salud conductual y apoyo comunitario.",
  88: "Servicios de salud conductual, rehabilitación y apoyo.",
  89: "Servicios de salud conductual, para familias y para la comunidad.",
  90: "Servicios de atención médica comunitaria de NOAH.",
  91: "Atención médica primaria y de salud conductual.",
  92: "Atención médica comunitaria mediante la red de NOAH.",
  93: "Servicios médicos, dentales y de salud conductual en la comunidad.",
  94: "Servicios de atención médica comunitaria asequibles.",
  95: "Servicios de atención médica comunitaria, incluida la atención pediátrica.",
  96: "Servicios de atención médica comunitaria, incluida la atención pediátrica.",
  97: "Servicios de centros de salud comunitarios en el centro de Phoenix.",
  98: "Servicios de atención médica comunitaria en el norte de Phoenix.",
  99: "Servicios de atención médica y salud conductual en la comunidad.",
  100: "Servicios de atención médica comunitaria en el centro de Phoenix.",
  101: "Servicios de atención médica comunitaria en Phoenix.",
  102: "Servicios de atención médica comunitaria en el sur de Phoenix.",
  103: "Servicios de atención primaria y salud conductual.",
  104: "Servicios de atención médica comunitaria.",
  105: "Servicios de atención médica comunitaria y de salud conductual.",
  106: "Servicios de empleo gratuitos, orientación profesional, búsqueda de empleo y capacitación.",
  107: "Búsqueda de empleo, currículums, entrevistas y apoyo para encontrar trabajo.",
  108: "Servicios de empleo, capacitación profesional y apoyo laboral.",
  109: "Ayuda para encontrar empleo y servicios de colocación laboral.",
  110: "Desarrollo profesional, educación y apoyo para el empleo.",
  111: "Apoyo para empleo, educación, familias y la comunidad.",
  112: "Redes profesionales, talleres y recursos para encontrar empleo.",
  113: "Capacitación tecnológica gratuita y desarrollo profesional.",
  114: "Oportunidades de empleo con la Ciudad de Phoenix.",
  115: "Programas de empleo, desarrollo de la fuerza laboral y oportunidades económicas.",
  116: "Capacitación laboral, empleo y servicios profesionales.",
  117: "Apoyo para encontrar empleo y desarrollar una carrera profesional en el área de Mesa.",
  118: "Información sobre empleo y desarrollo de la fuerza laboral para residentes de Tempe.",
  119: "Herramienta gratuita para evaluar programas de asistencia disponibles para los hogares.",
  120: "Preparación profesional, empleo y capacitación para jóvenes que cumplen los requisitos.",
  121: "Recursos en línea para empleo y desarrollo profesional.",
  122: "Recursos de empleo y servicios de la fuerza laboral mediante Arizona DES.",
  123: "Agencias locales que ayudan a los hogares a conseguir y mantener un empleo.",
  124: "Servicios de colocación laboral y apoyo para la fuerza laboral.",
  125: "Preparación profesional, apoyo para el empleo y capacitación.",
  126: "Desarrollo profesional y apoyo para la fuerza laboral.",
  127: "Apoyo para el desarrollo de la fuerza laboral y el empleo.",
  128: "Programas de desarrollo de la fuerza laboral y oportunidades económicas.",
  129: "Eventos profesionales gratuitos y oportunidades para establecer contactos.",
  130: "Información estatal sobre empleo y desarrollo de la fuerza laboral.",
  131: "Educación para adultos, preparación para el equivalente de secundaria, inglés como segundo idioma y preparación profesional.",
  132: "Preparación para el GED, aprendizaje de inglés y educación para adultos.",
  133: "Computadoras gratuitas, programas de alfabetización, ayuda con tareas, clases y recursos educativos.",
  134: "Programas gratuitos de alfabetización y aprendizaje de inglés para adultos.",
  135: "Educación y capacitación profesional gratuitas para jóvenes que cumplen los requisitos.",
  136: "Educación universitaria comunitaria, certificados, títulos y programas profesionales.",
  137: "Educación profesional y técnica, certificados y títulos.",
  138: "Programas de inglés, educación, apoyo para familias y capacitación laboral.",
  139: "Educación, preparación profesional y capacitación para jóvenes que cumplen los requisitos.",
  140: "Educación de la primera infancia y apoyo para las familias.",
  141: "Información estatal sobre alfabetización de adultos y programas educativos.",
  142: "Recursos para tareas y aprendizaje mediante la Biblioteca Pública de Phoenix.",
  143: "Computadoras públicas gratuitas y acceso a tecnología.",
  144: "Programas de alfabetización y educación.",
  145: "Educación para adultos y preparación para el equivalente de secundaria.",
  146: "Aprendizaje del inglés para estudiantes adultos que cumplen los requisitos.",
  147: "Aprendizaje del inglés y educación para adultos.",
  148: "Educación para adultos centrada en la preparación profesional.",
  149: "Programas profesionales y técnicos en todo el condado de Maricopa.",
  150: "Programas de certificados para la preparación profesional.",
  151: "Programas de educación profesional y técnica.",
  152: "Educación y capacitación vocacional para jóvenes que cumplen los requisitos.",
  153: "Desarrollo infantil temprano, educación, nutrición y apoyo para familias desde el nacimiento hasta los cinco años.",
  154: "Programas de inglés y educación.",
  155: "Información estatal sobre educación para adultos y servicios educativos.",
  156: "Autobuses y tren ligero en toda el área metropolitana de Phoenix.",
  157: "Transporte compartido para residentes de Phoenix con discapacidades que cumplen los requisitos.",
  158: "Transporte accesible para pasajeros que cumplen los requisitos.",
  159: "Opción de transporte para pasajeros que cumplen los requisitos.",
  160: "Conecta a los residentes con programas locales de transporte.",
  161: "Tarifas de transporte público reducidas para pasajeros que cumplen los requisitos.",
  162: "Rutas de autobús de Phoenix, programas y servicios de transporte.",
  163: "Información y servicios de transporte accesible.",
  164: "Apoyo de transporte para adultos mayores que cumplen los requisitos.",
  165: "Asistencia de transporte relacionada con servicios de NATIVE HEALTH para personas que cumplen los requisitos.",
  166: "Herramienta en línea para planificar viajes en transporte público.",
  167: "Transporte en autobús local y regional.",
  168: "Transporte en tren ligero en toda el área de Phoenix.",
  169: "Información sobre accesibilidad del transporte público de Phoenix.",
  170: "Información sobre accesibilidad y movilidad.",
  171: "Información actual sobre tarifas del transporte público.",
  172: "Programas y servicios de transporte de la ciudad.",
  173: "Información y registro para transporte compartido accesible.",
  174: "Directorio con búsqueda de ayuda para transporte.",
  175: "Información estatal sobre servicios de transporte.",
  176: "Ayuda para servicios públicos para hogares de bajos ingresos que cumplen los requisitos.",
  177: "Información sobre ayuda para servicios públicos en Arizona.",
  178: "Ayuda de emergencia que puede beneficiar a hogares que enfrentan dificultades con servicios públicos o necesidades básicas.",
  179: "Ayuda financiera para clientes de agua de Phoenix que cumplen los requisitos.",
  180: "Programas de ayuda para servicios públicos y pago de facturas.",
  181: "Programas de ayuda para el pago de facturas y apoyo energético.",
  182: "Programas de ayuda para pagos de gas para clientes que cumplen los requisitos.",
  183: "Apoyo comunitario de emergencia que puede incluir necesidades básicas del hogar.",
  184: "Ayuda comunitaria y apoyo para hogares que enfrentan dificultades.",
  185: "Ayuda de emergencia que puede incluir necesidades relacionadas con servicios públicos.",
  186: "Programas que pueden ayudar a los hogares que cumplen los requisitos a reducir los costos de energía mediante mejoras de eficiencia energética.",
  187: "Información de Mesa sobre ayuda para servicios públicos y programas de ahorro de energía.",
  188: "Ayuda para el pago de servicios públicos y apoyo para climatización.",
  189: "Orientación sobre recursos y asistencia para beneficios para adultos mayores.",
  190: "Directorio con búsqueda de ayuda para servicios públicos y asistencia financiera.",
  191: "Información estatal sobre ayuda para servicios públicos.",
  192: "Ayuda para la eficiencia energética de viviendas y servicios relacionados.",
  193: "Información de la ciudad sobre ayuda financiera para clientes de agua.",
  194: "Apoyo de emergencia y recursos de gestión de casos.",
  195: "Información sobre programas de ayuda para clientes de APS.",
  196: "Información sobre programas de ayuda para facturas de SRP.",
  197: "Información sobre ayuda para el pago del gas.",
  198: "Agencias locales que ofrecen ayuda para servicios públicos, climatización y emergencias.",
  199: "Directorio estatal de búsqueda y referencia para programas de asistencia.",
  200: "Buscador estatal de recursos para servicios públicos y otras necesidades básicas."
};

function translateToSpanish(text){
  const value=String(text??"");
  const exact={
    "Check official website":"Consulta el sitio web oficial",
    "Free or low-cost":"Gratis o de bajo costo",
    "Free":"Gratis",
    "Monthly":"Mensual",
    "Free screening tool":"Herramienta gratuita de evaluación",
    "English":"Inglés",
    "Spanish":"Español",
    "English, Spanish":"Inglés, Español",
    "Check website":"Consulta el sitio web",
    "Statewide":"Estatal"
  };
  return exact[value] ?? value;
}

function translateAccess(text,id,category,name,location,phone){
  const t=String(text??"");
  if(/^Use the official .*? website or call .*? to confirm the current food-distribution site, hours, and intake procedure for .*?\./.test(t)){
    const contact=phone==="Check website"?"consulta el sitio web oficial":`llama al ${phone}`;
    return `Utiliza el sitio web oficial de ${name} o ${contact} para confirmar el lugar actual de distribución de alimentos, los horarios y el procedimiento de atención para ${location}. Si la organización tiene varios lugares, selecciona el que atiende tu área antes de acudir.`;
  }
  if(t==="Open the linked directory, enter the household ZIP/location, and select a currently listed food pantry or meal provider before traveling."){
    return "Abre el directorio enlazado, ingresa el código postal o la ubicación de tu hogar y selecciona una despensa de alimentos o un proveedor de comidas que aparezca actualmente en el directorio antes de acudir.";
  }
  if(id===3){
    return "Solicita los beneficios a través de Arizona DES/Health-e-Arizona Plus, completa la solicitud y la entrevista requerida y presenta la documentación de verificación que DES solicite. Utiliza la página de asistencia nutricional de DES enlazada para acceder al proceso de solicitud vigente.";
  }
  if(id===4){
    return "Utiliza el portal para participantes de Arizona WIC enlazado arriba para completar la evaluación de elegibilidad, seleccionar una clínica de Arizona y seguir los pasos de registro para la cita de WIC.";
  }
  if(id===5){
    return "Lleva una tarjeta SNAP/EBT activa a un establecimiento participante de Double Up Arizona. El programa tiene procedimientos específicos para mercados de agricultores, tiendas de comestibles, CSA, puestos agrícolas, mercados móviles y establecimientos participantes en línea.";
  }
  if(/^Start with the official .*? site and follow its housing, shelter, rental, or legal-service intake instructions\./.test(t)){
    const statePhrase=t.includes("For Mesa, AZ services")?"Para los servicios de Mesa, AZ":t.includes("For Phoenix, AZ services")?"Para los servicios de Phoenix, AZ":"Para los servicios de Arizona";
    const callPart=phone==="Check website"?"utiliza el sitio para confirmar":"utiliza el sitio o llama al "+phone+" para confirmar";
    return `Comienza en el sitio oficial de ${name} y sigue sus instrucciones de admisión para vivienda, refugio, alquiler o servicios legales. ${statePhrase}, ${callPart} si se requiere una cita, una referencia, estar en una lista de espera o una evaluación antes de acudir.`;
  }
  if(/^Use the official .*? site to choose the appropriate clinic\/service and request an appointment or follow its patient-intake instructions\./.test(t)){
    const callMatch=t.match(/Call ([0-9-]+) to confirm accepted insurance\/payment options, new-patient availability, and the correct (.+?) service point\./);
    const call=callMatch?callMatch[1]:phone;
    const area=callMatch?callMatch[2]:location;
    return `Utiliza el sitio oficial de ${name} para elegir la clínica o el servicio adecuado y solicitar una cita, o sigue sus instrucciones de admisión para pacientes. Llama al ${call} para confirmar las opciones de seguro o pago aceptadas, la disponibilidad para pacientes nuevos y el centro de servicio correcto en ${area}.`;
  }
  if(/^Use the official .*? website to confirm accepted insurance\/payment options, new-patient availability, and the correct /.test(t)){
    const m=t.match(/^Use the official .*? website to confirm accepted insurance\/payment options, new-patient availability, and the correct (.+?) service point\.$/);
    return `Utiliza el sitio web oficial de ${name} para confirmar las opciones de seguro o pago aceptadas, la disponibilidad para pacientes nuevos y el centro de servicio correcto en ${m?m[1]:location}.`;
  }
  if(/^Use the official .*? employment page to create\/apply for the relevant job, training, or workforce service\./.test(t)){
    const m=t.match(/call (.*?) if the listing requires an appointment or local enrollment\./);
    const call=m?m[1]:phone;
    return `Utiliza la página oficial de empleo de ${name} para crear una solicitud o postularte al empleo, capacitación o servicio laboral correspondiente. Sigue los pasos de admisión o registro de la organización y llama al ${call} si la oferta requiere una cita o inscripción local.`;
  }
  if(/^Use the official .*? website if the listing requires an appointment or local enrollment\.$/.test(t)){
    return `Utiliza el sitio web oficial de ${name} si la oferta requiere una cita o inscripción local.`;
  }
  if(/^Open the official .*? program page, review the program-specific enrollment\/admission steps, and complete the required registration or application\./.test(t)){
    const m=t.match(/Call (.*?) to confirm placement, class availability, age requirements, or the correct (.+?) campus\./);
    const call=m?m[1]:phone;
    const campus=m?m[2]:location;
    const contact=call==="Check website"?"consulta el sitio web oficial":`llama al ${call}`;
    return `Abre la página oficial del programa de ${name}, revisa los pasos específicos de inscripción o admisión y completa el registro o la solicitud requeridos. Para confirmar la asignación de nivel, la disponibilidad de clases, los requisitos de edad o el campus correcto en ${campus}, ${contact}.`;
  }
  if(/^Use the official .*? page to plan, register, or request the transportation service\./.test(t)){
    const m=t.match(/call (.*?) to confirm the pickup\/service area for (.+?)\.$/);
    const call=m?m[1]:phone, area=m?m[2]:location;
    return `Utiliza la página oficial de ${name} para planificar, registrarte o solicitar el servicio de transporte. Si se requiere elegibilidad o una reserva previa, completa ese proceso antes de viajar; llama al ${call} para confirmar el área de recogida o de servicio en ${area}.`;
  }
  if(/^Use the official .*? page to review the applicable assistance program and follow its application or customer-assistance instructions\./.test(t)){
    const contact=phone==="Check website"?"consulta el sitio web oficial":`llama al ${phone}`;
    return `Utiliza la página oficial de ${name} para revisar el programa de asistencia correspondiente y seguir sus instrucciones de solicitud o atención al cliente. Ten a mano la información de tu cuenta y ${contact} para confirmar el financiamiento actual, las reglas del área de servicio y los pasos de admisión requeridos.`;
  }
  if(/^Use the official .*? website to confirm current funding, service-area rules, and required intake steps\.$/.test(t)){
    return `Utiliza el sitio web oficial de ${name} para confirmar el financiamiento actual, las reglas del área de servicio y los pasos de admisión requeridos.`;
  }
  return t;
}

function translateEligibility(text,id,category,name){
  const t=String(text??"");
  if(id===3) return "Los hogares de Arizona se evalúan conforme a las reglas de SNAP/Asistencia Nutricional, incluida la composición del hogar y la elegibilidad financiera; DES determina la elegibilidad después de la solicitud y la entrevista.";
  if(id===4) return "Pueden calificar los residentes de Arizona que estén embarazadas, hayan dado a luz recientemente, estén amamantando, sean bebés o sean niños menores de 5 años; se aplican requisitos de ingresos, participación en programas y riesgo nutricional.";
  if(id===5) return "Se requiere un saldo activo de SNAP/EBT y utilizarlo en un establecimiento participante de Double Up Arizona; no se requiere una solicitud independiente para Double Up.";
  if([16,17,29].includes(id)) return "Está dirigido a adultos mayores que cumplen los requisitos; el programa específico puede considerar la edad, los ingresos o la participación vigente en un programa de alimentos para adultos mayores.";
  if(category==="food") return `La elegibilidad depende del programa de alimentos y del lugar de distribución operado o incluido por ${name}; los programas locales de despensa pueden utilizar requisitos de residencia, necesidad del hogar o ingresos.`;
  if(category==="housing") return `La elegibilidad depende del programa y puede basarse en los ingresos y el tamaño del hogar, la situación de vivienda, la discapacidad o edad, la residencia o la propiedad o programa específico administrado por ${name}.`;
  if(category==="healthcare") return `Las reglas de elegibilidad y pago dependen del servicio específico de ${name}; la atención puede basarse en el seguro, los ingresos o las tarifas según capacidad de pago, la edad, la ubicación o la inscripción en un programa.`;
  if(category==="jobs") return `La elegibilidad depende del servicio específico de empleo o capacitación de ${name}; algunos programas pueden tener requisitos de edad, residencia, ingresos, situación laboral o participación en programas de empleo.`;
  if(category==="education") return `La elegibilidad depende del curso o programa específico de ${name}; los requisitos pueden incluir edad, educación previa, residencia, nivelación o criterios de inscripción específicos del programa.`;
  if(category==="transportation") return "La elegibilidad depende del programa de transporte específico; algunos servicios requieren elegibilidad por discapacidad o ADA, condición de adulto mayor, inscripción, reglas del área geográfica de servicio o registro previo.";
  if(category==="utilities") return "La elegibilidad depende del programa de asistencia y del proveedor específicos; pueden considerarse los ingresos, el tamaño del hogar, la dirección del servicio, el estado de la cuenta, el saldo vencido y los fondos disponibles.";
  return t;
}

function translateDocuments(text){
  const exact={
    "Bring the identification or residence/income documentation requested by the specific pantry or food program; requirements vary by distribution site. Do not assume digital copies are accepted.":"Lleva la identificación o los comprobantes de residencia o ingresos que solicite la despensa o el programa de alimentos específico; los requisitos varían según el lugar de distribución. No des por hecho que se aceptan copias digitales.",
    "Prepare identity/citizenship or lawful-status verification as applicable, Social Security information for applicants, household/income records, and—when relevant—rent/mortgage, utility, childcare, medical, and child-support expense verification.":"Prepara, según corresponda, comprobantes de identidad, ciudadanía o estatus legal, información del Seguro Social para los solicitantes, registros del hogar y de ingresos y, cuando corresponda, comprobantes de alquiler o hipoteca, servicios públicos, cuidado infantil, gastos médicos y manutención de hijos.",
    "For the WIC appointment, prepare household/member information, Arizona residence information, and any documents requested through the WIC eligibility/clinic registration process; the clinic will identify additional verification needed.":"Para la cita de WIC, prepara la información del hogar y de sus integrantes, información sobre la residencia en Arizona y cualquier documento solicitado durante el proceso de elegibilidad o registro en la clínica de WIC; la clínica indicará qué comprobantes adicionales se necesitan.",
    ...
    "Prepare government-issued ID, household member information, income/benefit verification, current lease or housing information, and any eviction/homelessness documentation that applies to the program; the provider may request additional documents.":"Prepara una identificación emitida por el gobierno, información de los integrantes del hogar, comprobantes de ingresos o beneficios, el contrato de alquiler vigente o información de vivienda y cualquier documentación sobre desalojo o falta de vivienda que corresponda al programa; el proveedor puede solicitar documentos adicionales.",
    "Prepare photo ID, insurance/AHCCCS information if applicable, contact information, medication/medical history, and income documentation if the clinic uses a sliding-fee program. Bring any referral or authorization the specific service requires.":"Prepara una identificación con foto, información del seguro o de AHCCCS si corresponde, datos de contacto, antecedentes médicos y de medicamentos y comprobantes de ingresos si la clínica utiliza tarifas según capacidad de pago. Lleva cualquier referencia o autorización que requiera el servicio específico.",
    "Prepare a current resume if available, government-issued ID/work-authorization documents when required for employment, contact information, education/training records, and any program-specific eligibility documentation.":"Prepara un currículum actualizado si tienes uno, una identificación emitida por el gobierno y documentos de autorización para trabajar cuando sean necesarios, datos de contacto, registros de educación o capacitación y cualquier documentación de elegibilidad específica del programa.",
    "Prepare photo ID, proof of residency when required, prior school/GED transcripts or placement information when applicable, and any program-specific enrollment documents. Do not submit original documents unless the institution specifically requires them.":"Prepara una identificación con foto, comprobante de residencia cuando sea necesario, certificados de estudios anteriores o del GED o información de nivelación cuando corresponda y cualquier documento específico de inscripción del programa. No entregues documentos originales a menos que la institución los solicite expresamente.",
    "Prepare photo ID and the information required for registration; ADA/paratransit services may require an eligibility application or certification, while reduced-fare programs may require age, disability, student, or income verification.":"Prepara una identificación con foto y la información necesaria para el registro; los servicios ADA/paratransit pueden requerir una solicitud o certificación de elegibilidad, mientras que los programas de tarifa reducida pueden requerir comprobantes de edad, discapacidad, condición de estudiante o ingresos.",
    "Prepare a current utility bill/account number, service address, household income information, photo ID, and any past-due/disconnection notice or benefit documentation requested by the assistance program.":"Prepara una factura de servicios públicos reciente o el número de cuenta, la dirección del servicio, información sobre los ingresos del hogar, una identificación con foto y cualquier aviso de saldo vencido o desconexión o documentación de beneficios que solicite el programa de asistencia."
  };
...
function makeResource(id, category, name, description, website, location = "Arizona", phone = "Check website", cost = "Free or low-cost", spanish = true, free = true, access = "") {
  ...
  const enAccess=access||detail.access||"Use the official website linked above for current intake instructions.";
  const enEligibility=detail.eligibility||"Eligibility is determined by the specific program; confirm current requirements with the organization.";
  const enDocuments=detail.documents||"Review the official website for the current document checklist.";
  return { id, category, name:{en:name,es:name}, description:{en:description,es:ES_DESCRIPTIONS[id]||description}, access:{en:enAccess,es:translateAccess(enAccess,id,category,name,location,phone)}, eligibility:{en:enEligibility,es:translateEligibility(enEligibility,id,category,name)}, documents:{en:enDocuments,es:translateDocuments(enDocuments)}, location, phone, hours:detail.hours||"Check official website", cost:{en:cost,es:translateToSpanish(cost)}, languages:spanish?"English, Spanish":"English", spanish, free, website, directionsQuery:detail.directionsQuery||`${name}, ${location}`, city:location.split(",")[0].trim(), zips:detail.zips||[] };
}
...
function createResourceCard(r){
  const l=currentLanguage,w=normalizeURL(r.website),d=createDirectionsURL(r),phone=r.phone&&r.phone!=="Check website"?`<a class="phone-link" href="${phoneHref(r.phone)}">${escapeHTML(r.phone)}</a>`:escapeHTML(l==="en"?r.phone:"Consulta el sitio web");
  ...
  return `<article class="resource-card ${local?"zip-match":""}" data-resource-id="${r.id}"><div class="card-top"><div><div class="category-label">${escapeHTML(categoryLabels[l][r.category])}</div><h3>${escapeHTML(r.name[l])}</h3></div><div class="badges">${r.free?`<span class="badge blue">${l==="en"?"Free / low-cost":"Gratis / de bajo costo"}</span>`:""}${r.spanish?`<span class="badge">${l==="en"?"Spanish available":"Español disponible"}</span>`:""}${near}</div></div><p class="resource-description">${escapeHTML(r.description[l])}</p><div class="details"><div class="detail"><strong>${l==="en"?"Location":"Ubicación"}</strong><span>${escapeHTML(r.location)}</span></div><div class="detail"><strong>${l==="en"?"Phone":"Teléfono"}</strong><span>${phone}</span></div><div class="detail"><strong>${l==="en"?"Hours":"Horario"}</strong><span>${escapeHTML(l==="en"?r.hours:translateToSpanish(r.hours))}</span></div><div class="detail"><strong>${l==="en"?"Cost":"Costo"}</strong><span>${escapeHTML(r.cost?.[l]??translateToSpanish(r.cost))}</span></div><div class="detail"><strong>${l==="en"?"Languages":"Idiomas"}</strong><span>${escapeHTML(l==="en"?r.languages:translateToSpanish(r.languages))}</span></div></div><div class="access-box"><strong>${l==="en"?"How to access":"Cómo acceder"}</strong><p>${escapeHTML(r.access[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Eligibility":"Requisitos"}:</b> ${escapeHTML(r.eligibility[l])}</p><p style="margin-top:7px"><b>${l==="en"?"Documents":"Documentos"}:</b> ${escapeHTML(r.documents[l])}</p></div><div class="card-actions"><a class="visit" href="${w}" target="_blank" rel="noopener noreferrer">${l==="en"?"Visit website":"Visitar sitio"} ↗</a><a class="directions" href="${d}" target="_blank" rel="noopener noreferrer">${l==="en"?"Directions":"Cómo llegar"} ↗</a></div></article>`;
}
...
function updateLanguage(){
  ...
  if(meta)meta.setAttribute("content",meta.dataset[currentLanguage]);
  const s=document.getElementById("search");
  s.placeholder=currentLanguage==="en"?s.dataset.placeholderEn:s.dataset.placeholderEs;
